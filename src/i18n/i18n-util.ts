...
export function i18n(): LocaleTranslationFunctions<Locales, Translations, TranslationFunctions> {
  return initI18n<Locales, Translations, TranslationFunctions, Formatters>(loadedLocales, loadedFormatters)
}
